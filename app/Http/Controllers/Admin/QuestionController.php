...
class QuestionController extends Controller
{
    ...
    public function store(QuestionCreateRequest $request,$id)
    {
        ...
        return redirect()->route('questions.index',$id)->withSuccess('Soru basariyla olusturuldu');
    }
    ...
    {
        $question= Quiz::find($quiz_id)->questions()->whereId($question_id)->first() ?? abort(404,'Quiz veya Soru Bulunamadi');
    ...
    public function update(QuestionUpdateRequest $request, $quiz_id,$question_id)
    {
        ...
        return redirect()->route('questions.index',$quiz_id)->withSuccess('Soru basariyla guncellendi');
    }
    ...
    public function destroy($quiz_id,$question_id)
    {
        ...
        return redirect()->route('questions.index',$quiz_id)->withSuccess('Soru basariyla silindi');
    }
}
