...
class MainController extends Controller
{
    ...
    public function quiz($slug){
        $quiz=Quiz::whereSlug($slug)->with('questions.my_answer','my_result')->first() ?? abort(404,'Quiz Bulunamadi');
    ...
    public function quiz_detail($slug){
        $quiz=Quiz::whereSlug($slug)->with('my_result','topTen')->withCount('questions')->first() ?? abort(404,'Quiz Bulunamadi');
    ...
    public function result(Request $request,$slug)
    {
        ...
        return redirect()->route('quiz.detail',$quiz->slug)->withSuccess("Basariyla Quiz'i bitirdin. Puanin:".$point);
    }
}
